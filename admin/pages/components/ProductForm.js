            ...
            <div class="mb-2 flex">
                {
                    !!images?.length && images.map((link, index) =>(
                        <div key={index}>
                            <img className="w-24 h-24 object-contain" src={link} alt="Product Image" />
                        </div>
                    ))
                }
                <label htmlFor='images' className="w-24 h-24 border bg-gray-100 hover:bg-gray-200 flex flex-col items-center justify-center text-md hover:text-lg cursor-pointer">
